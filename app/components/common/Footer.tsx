        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed">
              Leading the way in commercial dispatch and roadside solutions
              across all 50 states. Reliable, fast, and professional support for
              fleets of all sizes.
            </p>
          ...
          <div>
            <h4 className="text-white font-bold uppercase tracking-widest text-[10px] mb-6">
              Dispatch Capabilities
            </h4>
            <ul className="space-y-4 text-sm">
              ...
              <li>
                <Link
                  ...
                  className="hover:text-white transition-colors"
                >
                  Light Utility Assist
                </Link>
              </li>
              <li>
                <Link
                  href="#vehicle-classes"
                  className="hover:text-white transition-colors"
                >
                  Fleet Weight Guide
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Book Fly Drive Stay 11727<br /> East End Avenue Chino, California
                  91710
                </span>
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:support@nationwideroadside.com"
                  className="hover:text-brand-primary transition-colors"
                >
                  Ers@nationwideroadsideassist.com
                </a>
              </li>
            </ul>
          </div>
